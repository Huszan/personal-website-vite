...
const projectsData: Project[] = [
  {
    ...
    imageSrc: "./src/assets/images/PW_capture.PNG",
  ...
  {
    title: "Manga dot",
    imageSrc: "./src/assets/images/manga-dot-capture-min.PNG",
  ...
  {
    title: "Yurpiland",
    imageSrc: "./src/assets/images/yurpiland_capture.PNG",
  ...
  },
  {
    ...
    imageSrc: "./src/assets/images/EMA_capture.PNG",
  ...
  {
    title: "Board Games",
    imageSrc: "./src/assets/images/boardgames_capture.PNG",
  ...
  },
  {
    ...
    imageSrc: "./src/assets/images/parallax-capture-min.PNG",
  ...
  {
    title: "Particles",
    imageSrc: "./src/assets/images/particle-capture-min.PNG",
